...
Z_fine_consistency = tf.nn.sigmoid(tf.add(tf.matmul(Z_fine_consistency, W_2_fine, name="multiply_weights"), b_2_fine, name="add_bias"))

Z_coarse_consistency = tf.nn.sigmoid(tf.add(tf.matmul(X_coarse_consistency, W_1_coarse, name="multiply_weights"), b_1_fine, name="add_bias"))
Z_coarse_consistency = tf.nn.sigmoid(tf.add(tf.matmul(Z_coarse_consistency, W_2_coarse, name="multiply_weights"), b_2_fine, name="add_bias"))
...
with tf.Session() as sess:
    ...
    save_path = saver.save(sess, os.path.join(config.MODEL_DIR, "MULTI_RES", "MIL", "model.ckpt"))
