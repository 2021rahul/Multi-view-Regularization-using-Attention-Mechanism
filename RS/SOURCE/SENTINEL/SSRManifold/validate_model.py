...
# %%
print("LOAD DATA")
validate_data = np.load(os.path.join(config.NUMPY_DIR, "sentinel_validate_data.npy"))
num_features = 12
# %%
print("BUILD MODEL")
...
with tf.Session() as sess:
    saver.restore(sess, os.path.join(config.MODEL_DIR, "SENTINEL", "SSRManifold", "model.ckpt"))
