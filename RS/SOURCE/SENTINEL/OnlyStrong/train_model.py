...
with tf.Session() as sess:
    summary_writer = tf.summary.FileWriter(os.path.join(config.MODEL_DIR, "SENTINEL", "OnlyStrong"), sess.graph)
    ...
    save_path = saver.save(sess, os.path.join(config.MODEL_DIR, "SENTINEL", "OnlyStrong", "model.ckpt"))
