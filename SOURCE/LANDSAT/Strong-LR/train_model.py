...
# -*- coding: utf-8 -*-
"""
Created on Wed Aug 21 14:03:49 2019
...
with tf.Session() as sess:
    summary_writer = tf.summary.FileWriter(os.path.join(config.MODEL_DIR, "LANDSAT", "Strong-LR"), sess.graph)
    ...
    save_path = saver.save(sess, os.path.join(config.MODEL_DIR, "LANDSAT", "Strong-LR", "model.ckpt"))
