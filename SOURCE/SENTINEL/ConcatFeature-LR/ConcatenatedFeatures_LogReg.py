...
# -*- coding: utf-8 -*-
"""
Created on Tue Jul  2 16:41:08 2019
...
with tf.Session() as sess:
    summary_writer = tf.summary.FileWriter("../../MODEL/SENTINEL/ConcatenatedFeatures_LogReg", sess.graph)
    ...
    save_path = saver.save(sess, "../../MODEL/SENTINEL/ConcatenatedFeatures_LogReg/"+REGION+"_"+str(num_train_samples)+".CKPT")
# %%
# TEST MODEL ON TRAIN DATA
with tf.Session() as sess:
    saver.restore(sess, "../../MODEL/SENTINEL/ConcatenatedFeatures_LogReg/"+REGION+"_"+str(num_train_samples)+".CKPT")
    data = train_data[:, :-1]
    feed_dict = {X: data}
