...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun 23 07:52:08 2019
...
unlabeled_fine = np.load(os.path.join(data_dir, "sentinel_unlabeled.npy"))
unlabeled_coarse = np.load(os.path.join(data_dir, "landsat_unlabeled.npy"))
# %%
learning_rate = 0.01
n_epochs = 10000
