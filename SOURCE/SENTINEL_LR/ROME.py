...
# -*- coding: utf-8 -*-
"""
Created on Sun Jun 23 07:41:13 2019
...
with tf.Session() as sess:
    summary_writer = tf.summary.FileWriter("../../MODEL/SENTINEL-LR", sess.graph)
    ...
    save_path = saver.save(sess, "../../MODEL/SENTINEL-LR/ROME.CKPT")
# %%
# TEST MODEL ON TRAIN DATA
with tf.Session() as sess:
    saver.restore(sess, "../../MODEL/SENTINEL-LR/ROME.CKPT")
    data = train_data[:, :-1]
    feed_dict = {X: data}
