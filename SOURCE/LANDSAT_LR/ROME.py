...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 22 21:23:23 2019
...
with tf.Session() as sess:
    summary_writer = tf.summary.FileWriter("../../MODEL/LANDSAT-LR", sess.graph)
    ...
    save_path = saver.save(sess, "../../MODEL/LANDSAT-LR/ROME.CKPT")
# %%
# TEST MODEL ON TRAIN DATA
with tf.Session() as sess:
    saver.restore(sess, "../../MODEL/LANDSAT-LR/ROME.CKPT")
    data = train_data[:, :-1]
    feed_dict = {X: data}
